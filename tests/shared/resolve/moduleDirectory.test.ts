...
describe('moduleDirectory', () => {
  ...
  it('handles file urls', () => {
    expect(moduleDirectory('file:///repo/src/shared/resolve/repoRoot.ts')).toBe(
      '/repo/src/shared/resolve'
    );
  });

  it('handles absolute module paths', () => {
    expect(moduleDirectory('/repo/src/shared/resolve/repoRoot.ts')).toBe(
      '/repo/src/shared/resolve'
    );
  });
